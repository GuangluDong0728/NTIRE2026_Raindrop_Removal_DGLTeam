...
class TianDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(TianDataset, self).__init__()
        self.opt = opt
        ...
        self.dataset_texts = []  # 新增：每个子数据集的固定文本
        ...
        for i, dataset_opt in enumerate(opt['datasets']):
            ...
            self.dataset_texts.append(dataset_opt.get('fixed_text', None))
    ...
    def __getitem__(self, index):
        ...
        return {
            ...
            'text': self.dataset_texts[dataset_idx]
        }
