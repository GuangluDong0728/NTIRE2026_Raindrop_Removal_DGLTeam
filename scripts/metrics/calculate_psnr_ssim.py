...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/root/autodl-tmp/unsupervised deraining/unsupervised/results/CSUD_Rain100L_TTO/visualization/Rain100L_blend_0.005', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/root/autodl-tmp/unsupervised deraining/datasets/Rain100L/target', help='Path to restored images')
